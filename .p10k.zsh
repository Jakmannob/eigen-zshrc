# Generated by Powerlevel10k configuration wizard on 2025-01-14 at 14:30 CET.
...
#status|command_execution_time|background_jobs|direnv|asdf|virtualenv|anaconda|pyenv|goenv|nodenv|nvm|nodeenv|node_version|go_version|rust_version|dotnet_version|php_version|laravel_version|java_version|package|rbenv|rvm|fvm|luaenv|jenv|plenv|perlbrew|phpenv|scalaenv|haskell_stack|kubecontext|terraform|terraform_version|aws|aws_eb_env|azure|gcloud|google_app_cred|toolbox|context|nordvpn|ranger|nnn|lf|xplr|vim_shell|midnight_commander|nix_shell|chezmoi_shell|vi_mode|vpn_ip|load|disk_usage|ram|swap|todo|timewarrior|taskwarrior|per_directory_history|cpu_arch|ip|public_ip|proxy|battery|wifi|example
  ...
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=OVRTYP
...
#  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+⇡$P9K_IP_TX_RATE }$P9K_IP_IP'
  ...
  function p10k-on-post-prompt() { p10k display '1/left/(dir|vcs|os_icon)'=hide '1/left/prompt_char'=show '1/right/(status|command_execution_time|background_jobs|direnv|asdf|virtualenv|anaconda|pyenv|goenv|nodenv|nvm|nodeenv|node_version|go_version|rust_version|dotnet_version|php_version|laravel_version|java_version|package|rbenv|rvm|fvm|luaenv|jenv|plenv|perlbrew|phpenv|scalaenv|haskell_stack|kubecontext|terraform|terraform_version|aws|aws_eb_env|azure|gcloud|google_app_cred|toolbox|context|nordvpn|ranger|nnn|lf|xplr|vim_shell|midnight_commander|nix_shell|chezmoi_shell|vi_mode|vpn_ip|load|disk_usage|ram|swap|todo|timewarrior|taskwarrior|per_directory_history|cpu_arch|ip|public_ip|proxy|battery|wifi|example)'=hide '1/right/time'=show }
  function p10k-on-pre-prompt() { p10k display '1/left/(dir|vcs|os_icon)'=show '1/left/prompt_char'=hide '1/right/(status|command_execution_time|background_jobs|direnv|asdf|virtualenv|anaconda|pyenv|goenv|nodenv|nvm|nodeenv|node_version|go_version|rust_version|dotnet_version|php_version|laravel_version|java_version|package|rbenv|rvm|fvm|luaenv|jenv|plenv|perlbrew|phpenv|scalaenv|haskell_stack|kubecontext|terraform|terraform_version|aws|aws_eb_env|azure|gcloud|google_app_cred|toolbox|context|nordvpn|ranger|nnn|lf|xplr|vim_shell|midnight_commander|nix_shell|chezmoi_shell|vi_mode|vpn_ip|load|disk_usage|ram|swap|todo|timewarrior|taskwarrior|per_directory_history|cpu_arch|ip|public_ip|proxy|battery|wifi|example)'=show '1/right/time'=show  }
